...
import com.example.wheelview.utils.DisplayUtils;
...
public class WheelView extends View {
	...
	private static final int TEXT_SIZE = 20; //瀛椾�?
	...
	private boolean alignmentLR;//鏄乏杈硅繕鏈夊�?
	private boolean alignmentCenter = false; //濡傛灉璁剧疆浜嗚繖涓�?硷紝閭ｄ箞灏辨槸鏄剧ず灏辨槸灞呬�?
	// Text paints
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			int sp2px = DisplayUtils.sp2px(getContext(), TEXT_SIZE);
			itemsPaint.setTextSize(sp2px);
		}
	...
	private void createLayouts(int widthItems, int widthLabel) {
		Alignment alignNormal = null;
		if(alignmentLR&&!alignmentCenter){
			alignNormal = Layout.Alignment.ALIGN_NORMAL;
		}else if(!alignmentLR&&!alignmentCenter){
			alignNormal = Layout.Alignment.ALIGN_OPPOSITE;
		}
		if(alignmentCenter){
			alignNormal = Layout.Alignment.ALIGN_CENTER;
		}
		if (itemsLayout == null || itemsLayout.getWidth() > widthItems) {
			...
			itemsLayout = new StaticLayout(buildText(isScrollingPerformed)
					...
					, widthItems
					,alignNormal
//					, alignmentLR? Layout.Alignment.ALIGN_NORMAL: Layout.Alignment.ALIGN_OPPOSITE 
...
//											, alignmentLR? Layout.Alignment.ALIGN_NORMAL: Layout.Alignment.ALIGN_OPPOSITE
	...
	public boolean isAlignmentLR() {
		return alignmentLR;
	}

	public void setAlignmentLR(boolean alignmentLR) {
		this.alignmentLR = alignmentLR;
	}
